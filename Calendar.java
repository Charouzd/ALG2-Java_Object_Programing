...
public class Calendar {
    ...
    private int month;
    private int year;
    private int[] daysInMonth = {31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31}; //mesice od lednado do prosince reprezentované poctem dni
    ...
    public static void main(String[] args) {
        ...
        System.out.println("prestupny rok: "+isLeapYear(year));
    ...
    public static void callMenu(Calendar c) {
        int vysledek = c.getMenu();
        while (vysledek != 0) {
            if (vysledek == 1) {
                c.nextMonth();
            } else if (vysledek == -1) {
    ...
    public int Zeller(int day, int month, int year) { //den v tydnu
        ...
        int K = year % 100;
        int J = year / 100;
        //využití informace o zjišťování dne podle internetu
        switch(month){
            case 1:
                m = 13;
                K -= 1;
    ...
    public static boolean isLeapYear(int year) { //prestupny rok
        // pestupny rok je delitelny 4(ale ne 100!) nebo 400
    ...
    public String getCalendar() {
        ...
        sb.append("\n");
//pokud je přestupny rok v unoru je o den vic
